...
//arrow function com uma linha sem chaves e sem return
...
// fiz lá em cima, estava dando erro ao rodar duas vezes...
...
const resultadoSubtracao = calcular(10,4, subtrair)

console.log(`A subtração de 10 e 4 é: ${resultadoSubtracao}`)


// Faça a multiplicação de dois números usando a função calcular

const resultadoMult = calcular(2,8, multiplicar)

console.log(`A multiplicação entre 2 e 8 é: ${resultadoMult}`)
...
console.log(`A divisão entre 100 e 5 é: ${resultadoDivisao}`)
...
console.log(`Colocados em ordem crescente os números 11 e 7: ${ordenaPraGente}`);
...
console.log(`O estudante foi ${resultado}`);
...
console.log(`Capiturei o pokemom ${name} que tem tipo ${type} e tem altura de  ${height} cm`)
...
const pessoa3 = new Pessoa('Pedro', 'Lopes', 7)
...
const pessoa4 = new Pessoa('Edlaine', 'Pontes', 36, true, 300)
...
const tiasSP = tias.filter(elemento => 
 elemento.local === 'SP')
...
/* const comparar = (a, b) => {
  if (a < b) { // mantenho a como primeiro  e depois vem b
    return -1
  } else if (a > b) { // primeiro o b vem depois a
    return 1
...
// acumulador iniciou em 10
const arrayReduzido = numbers.reduce((acumulador, item) =>
   acumulador + item, 10)
...
// começou em 1 para me somar como neta
